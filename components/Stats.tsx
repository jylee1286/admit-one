...
export default function Stats() {
  ...
  return (
    <section id="stats" className="bg-cream py-24 md:py-32">
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0">
          {/* Stat 1 */}
          <div ref={stat1.ref} className="flex flex-col items-center text-center md:border-r md:border-border">
            <span className="font-serif text-navy leading-none" style={{ fontSize: "clamp(72px, 8vw, 96px)" }}>
              T{stat1.count}
            </span>
            <span className="text-secondary font-sans text-sm mt-3 tracking-wide uppercase">
              Schools Covered
            </span>
          </div>
          ...
          <div ref={stat2.ref} className="flex flex-col items-center text-center md:border-r md:border-border">
            <span className="font-serif text-gold leading-none" style={{ fontSize: "clamp(72px, 8vw, 96px)" }}>
              {stat2.count}+
            </span>
            <span className="text-secondary font-sans text-sm mt-3 tracking-wide uppercase">
